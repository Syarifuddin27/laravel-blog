...
@section('content')
    ...
    <div class="stunning-header stunning-header-bg-lightviolet">
        <div class="stunning-header-content">
            <h1 class="stunning-header-title" style="text-transform: capitalize;">{{ $post->title }}</h1>
        </div>
    </div>
                ...
                <div class="col-lg-10 col-lg-offset-1">
                    ...
                    <div class="blog-details-author">
                        ...
                        <div class="blog-details-author-thumb">
                            <img src="{{ asset($post->user->profile->avatar) }}" alt="Author" width="90px" height="auto" style="border-radius: 50%;">
                        </div>
